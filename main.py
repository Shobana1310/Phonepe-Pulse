...
if selected == 'HOME':
   st.write('')
   st.write('')
   image_path ="D:\OneDrive\Pictures\phonepe project\phonepe pulse.png"
   ...
   with st.container():
         ...
         with right_column:
            ...
            image_path ="D:/OneDrive/Pictures/phonepe project/bs-hero-banner-image1.png"
            image = Image.open(image_path)
   ...
   with st.container():
         left_column,right_column=st.columns(2)
         with left_column:
            image_path ="D:\OneDrive\Pictures\phonepe project\download.png"
            image = Image.open(image_path)
         ...
         with right_column:
            image_path ="D:\OneDrive\Pictures\phonepe project\download (1).png"
            image = Image.open(image_path)
            st.image(image,width=100)
   ...
   with st.container():
         left_column,right_column=st.columns(2)
         with left_column:
            image_path ="D:\OneDrive\Pictures\phonepe project\download (2).png"
            image = Image.open(image_path)
            st.image(image,width=100)
         ...
         with right_column:
            image_path ="D:\OneDrive\Pictures\phonepe project\download (3).png"
            image = Image.open(image_path)
            st.image(image,width=100)
...
if selected=='TOP INSIGHTS':
  ...
  if Analyse_method=='User':
    with st.container():
           left_column,right_column=st.columns(2)
           with left_column:
               image_path ="D:\OneDrive\Pictures\phonepe project\GettyImages-1234065228.jpg"
               image = Image.open(image_path)
               st.image(image, use_column_width=True)
  ...
  if Analyse_method=='Transaction':
        with st.container():
           left_column,right_column=st.columns(2)
           with left_column:
               image_path ="D:\OneDrive\Pictures\phonepe project\phone-pe-yes-bank-768x384.jpg"
               image = Image.open(image_path)
               st.image(image, use_column_width=True)
  ...
  if Analyse_method=='Insurance':
        with st.container():
           left_column,right_column=st.columns(2)
           with left_column:
               image_path ='D:\OneDrive\Pictures\phonepe project\PhonePe-Copy.jpg'
               image = Image.open(image_path)
               st.image(image, use_column_width=True)
        option=st.radio('How would you like to Analyse?',['State Wise','District Wise'],index=None,horizontal=True)  
        st.write('You selected:', option)
...
if selected=='REPORT':
   with st.container():
           ...
           with left_column:
               ...
               image_path ="D:\OneDrive\Pictures\phonepe project\Brown Autumn Photo Collage.png"
               image = Image.open(image_path)
               st.image(image, use_column_width=True)
           with right_column:
               first_half, second_half = right_column.columns(2)
               with first_half:
                  image_path ="D:\OneDrive\Pictures\phonepe project\Edit Logo Design and Branding.png"
                  image = Image.open(image_path)
                  st.image(image, use_column_width=True)
               with second_half:
                 ...
                 st.write(' ')
                 st.write(' ')
                 with open("C:/Users/Shobana/Downloads/final Phonepe Book (1).pdf", "rb") as pdf_file:
